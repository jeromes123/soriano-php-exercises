...
class StrModel
{
    ...
    {
        $result = $this->printStr();
        $result .= $this->printLength();
        $result .= $this->printToLowercase();
        $result .= $this->printToUppercase();
        $result .= $this->printUppercaseFirst();
        $result .= $this->printLowercaseFirst();
        $result .= $this->printUppercaseEveryWord();
        $result .= $this->printReversedString();
        return $result;
    }
}
